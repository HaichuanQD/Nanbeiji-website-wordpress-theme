...
function wp_bootstrap_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => __( '上一页', 'text-domain' ),
        'next_string'     => __( '下一页', 'text-domain' ),
    ...
    if ( $firstpage && (1 != $page) )
        $echo .= '<li class="previous"><a href="' . $firstpage . '">' . __( '首页', 'text-domain' ) . '</a></li>';
    ...
    if ( $lastpage ) {
        $echo .= '<li class="next"><a href="' . $lastpage . '">' . __( '尾页', 'text-domain' ) . '</a></li>';
    }
